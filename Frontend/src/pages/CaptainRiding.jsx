...
const CaptainRiding = () => {
    ...
    return (
        <div className='h-screen flex flex-col relative'>
            ...
            <div className="relative z-20 h-1/5 p-6 bg-yellow-400 flex items-center justify-between " onClick={() => {
            ...
            <div ref={finishRidePanelRef} className="fixed w-full z-30 bottom-0 translate-y-full bg-white px-3 py-10 pt-12">
