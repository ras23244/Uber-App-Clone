...
const ConfirmedRide = (props) => {
    return (
        <div>
            ...
            <h3 className='text-xl font-semibold '>Confirm your Vehicle</h3>
            <div className='flex flex-col justify-between items-center gap-2'>
                
                <img className='-mt-12' src="https://www.pngplay.com/wp-content/uploads/8/Uber-PNG-Photos.png" alt="" />
                ...
                }} className='w-full mt-5 bg-green-600 text-white font-semibold text-xl rounded p-2'>Confirm</button>
            </div>
